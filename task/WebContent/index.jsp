	...
	<body>
		<div class="layui-layout layui-layout-admin" style="border-bottom: solid 5px #1aa094;">
			<div class="layui-header header header-demo">
				<div class="layui-main">
					<div class="admin-login-box">
						<a class="logo" style="left: 0;" href="<%=realPath %>jsp/index.jsp">
			...
			<div class="layui-footer footer footer-demo" id="admin-footer">
				<div class="layui-main">
					<p>2018 &copy;
						<a href="http://m.zhengjinfan.cn/">tibos</a> 某个未知名系统
					</p>
				</div>
			</div>
			...
			<script type="text/template" id="lock-temp">
				<div class="admin-header-lock" id="lock-box">
					<div class="admin-header-lock-img">
						<img src="<%=session.getAttribute("pic")%>"/>
					</div>
					<div class="admin-header-lock-name" id="lockUserName"><%=session.getAttribute("name")%></div>
				...
				layui.use('layer', function() {
                    ...
                    $('#pay').on('click', function () {
                        layer.open({
                            title: false,
                            type: 1,
                            content: '<img src="<%=path%>/images/tibos.jpg" width="250px" height="300px"/>',
                            area: ['250px', '300px'],
                            shadeClose: true
                        });
                    });
